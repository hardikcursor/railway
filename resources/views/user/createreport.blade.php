    ...
    <script>
        $(document).ready(function() {
            ...
            $('#daily_form').on('submit', function(e) {
                e.preventDefault();
                $.ajax({
                    url: "{{ route('user.savequotationreport') }}",
                    type: "POST",
                    data: $(this).serialize(),
                    success: function() {
            ...
            $('#prs_form').on('submit', function(e) {
                e.preventDefault();
                $.ajax({
                    url: "{{ route('user.PRSanswer.store') }}",
                    type: "POST",
                    data: $(this).serialize(),
                    success: function() {
                        $('#success-message').show().delay(3000).fadeOut();
            ...
            $('#parcel_form').on('submit', function(e) {
                e.preventDefault();
                $.ajax({
                    url: "{{ route('user.Parcelanswer.store') }}",
                    type: "POST",
                    data: $(this).serialize(),
                    success: function() {
                        $('#success-message').show().delay(3000).fadeOut();
            ...
            $('#goods_form').on('submit', function(e) {
                e.preventDefault();
                $.ajax({
                    url: "{{ route('user.GoodsShedanswer.store') }}",
                    type: "POST",
                    data: $(this).serialize(),
                    success: function() {
                        $('#success-message').show().delay(3000).fadeOut();
            ...
            $('#ticket_form').on('submit', function(e) {
                e.preventDefault();
                $.ajax({
                    url: "{{ route('user.TicketExamineranswer.store') }}",
                    type: "POST",
                    data: $(this).serialize(),
                    success: function() {
                        $('#success-message').show().delay(3000).fadeOut();
            ...
            $('#nonfare_form').on('submit', function(e) {
                e.preventDefault();
                $.ajax({
                    url: "{{ route('user.nonfareanswer.store') }}",
                    type: "POST",
                    data: $(this).serialize(),
                    success: function() {
                        $('#success-message').show().delay(3000).fadeOut();
            ...
            $('#passenger_form').on('submit', function(e) {
                e.preventDefault();
                $.ajax({
                    url: "{{ route('user.inspectionpassengeranswer.store') }}",
                    type: "POST",
                    data: $(this).serialize(),
                    success: function() {
                        $('#success-message').show().delay(3000).fadeOut();
            ...
            $('#stationcleanliness_form').on('submit', function(e) {
                e.preventDefault();
                $.ajax({
                    url: "{{ route('user.stationcleanlinessanswer.store') }}",
                    type: "POST",
                    data: $(this).serialize(),
                    success: function() {
                        $('#success-message').show().delay(3000).fadeOut();
            ...
            $('#payuse_form').on('submit', function(e) {
                e.preventDefault();
                $.ajax({
                    url: "{{ route('user.inspectionpayuseanswer.store') }}",
                    type: "POST",
                    data: $(this).serialize(),
                    success: function() {
                        $('#success-message').show().delay(3000).fadeOut();
            ...
            $('#tea_form').on('submit', function(e) {
                e.preventDefault();
                $.ajax({
                    url: "{{ route('user.inspectionteaanswer.store') }}",
                    type: "POST",
                    data: $(this).serialize(),
                    success: function() {
                        $('#success-message').show().delay(3000).fadeOut();
            ...
            $('#pantry_form').on('submit', function(e) {
                e.preventDefault();
                $.ajax({
                    url: "{{ route('user.inspectionpantrycaranswer.store') }}",
                    type: "POST",
                    data: $(this).serialize(),
                    success: function() {
                        $('#success-message').show().delay(3000).fadeOut();
            ...
            $('#base_form').on('submit', function(e) {
                e.preventDefault();
                $.ajax({
                    url: "{{ route('user.inspectionkitchenanswer.store') }}",
                    type: "POST",
                    data: $(this).serialize(),
                    success: function() {
                        $('#success-message').show().delay(3000).fadeOut();
